...
class VisitController(http.Controller):
    ...
    def get_visits(self,**kw): 
        try: 
            ...
            return Response(res, content_type='applicacion/json;charset=utf-8', status=200)
        except Exception as e:
            return Response(json.dumps({'error':str(e)}), content_type='applicacion/json;charset=utf-8', status=505)
